...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/broken-recipe-cf20)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/broken-recipe-cf20
```

A live public deployment of this template is available at [https://broken-recipe-cf20.templates.workers.dev](https://broken-recipe-cf20.templates.workers.dev)
